---
name: ct:init
description: 저장소 초기화 직후 core_project.md, core_code_style.md, core_workflow.md 3개 문서를 재생성하고, AGENTS.md는 core 문서 참조만 유지하도록 정리한다. `$ct-init`, `ct-init`, `문서 초기화`, `core 문서 재생성`, `init 문서 작성` 요청에 사용한다.
---
